...
import { ItemAnimation, ShopItemDetailModal } from '@/components/shop/ShopItemDetailModal'
import { Button } from '@/components/ui/Button'
import type { ShopItem, ShopItemType } from '@/types'

function PurchaseSuccessModal({ item, onClose }: { item: ShopItem; onClose: () => void }) {
  return (
    <div
...
export function Tienda() {
  ...
  return (
    <div className="space-y-6">
      ...
      {purchaseCelebration && (
        <PurchaseSuccessModal item={purchaseCelebration} onClose={() => setPurchaseCelebration(null)} />
      )}
    </div>
  )
}
