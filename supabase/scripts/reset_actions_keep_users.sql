...
--      action_claims, action_records, action_requests, user_level_medals.
--   2. Deja intactas: public.users, public.action_types, public.global_config.
--   3. Restaura points_balance y lifetime_points_earned al valor por defecto (100).
--
-- Cómo usarlo:
...
-- 6. Medallas por nivel (opcional coherente con saldo / historial vacío)
DELETE FROM public.user_level_medals;

-- 7. Restaurar saldo y puntos de vida iniciales (como al registrarse)
UPDATE public.users
