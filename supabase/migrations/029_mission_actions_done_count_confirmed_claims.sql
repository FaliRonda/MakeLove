-- MakeLove - Las acciones confirmadas por la pareja (action_records.record_claim_id)
-- deben contar para métrica actions_done. Antes se excluían y la misión quedaba en 0/1
-- aunque el movimiento en historial de saldo y la experiencia fueran correctos.
